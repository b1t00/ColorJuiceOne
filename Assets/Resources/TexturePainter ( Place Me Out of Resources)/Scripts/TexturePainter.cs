...
public class TexturePainter : MonoBehaviour {
	...
	float brushSize=0.4f; //The size of our brush
	...
	void Update () {
        ...
        //Color auswahl = spraycanRenderer.material.GetColor("_Color");
	...
	bool HitTestUVPosition(ref Vector3 uvWorldPosition){
        ...
        Ray cursorRay = new Ray(pysicsPointer.transform.position, pysicsPointer.transform.forward);
